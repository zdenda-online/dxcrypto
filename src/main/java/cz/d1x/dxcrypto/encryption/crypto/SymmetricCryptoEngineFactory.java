 ...
 */
public class SymmetricCryptoEngineFactory implements SymmetricEncryptionEngineFactory<ByteArray> {
     ...
     */
    public SymmetricCryptoEngineFactory(String algorithmName) {
