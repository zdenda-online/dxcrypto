...
public final class RSAAlgorithmBuilder {
    ...
    private RSAEngineFactory engineFactory;
     ...
     */
    public RSAAlgorithmBuilder(RSAEngineFactory engineFactory) {
     ...
     */
    public RSAAlgorithmBuilder engineFactory(RSAEngineFactory engineFactory) throws IllegalArgumentException {
    ...
    public EncryptionAlgorithm build() throws IllegalArgumentException {
        EncryptionEngine engine = engineFactory.newEngine(modulus, publicExponent, privateExponent);
